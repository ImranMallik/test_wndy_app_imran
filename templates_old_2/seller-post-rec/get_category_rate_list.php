...
echo '<div class="container pb-4" style="background-color: #e2ebdd; border-radius:8px;">
        <h2 class="text-center pt-3">' . htmlspecialchars($categoryData['category_name']) . ' Rate List In Rs. ₹</h2>';
...
if (mysqli_num_rows($dataget) > 0) {
    ...
    echo '<p class="rate-list-description">Scrap is valued by weight. Final rates depend on the weight of collected products.</p>
                <div class="scrollable-container" >
                    <table class="table table-bordered table-hover" style="margin: 0; width: 100%;">
                        <thead style="position: sticky; top: 0; z-index: 9999; background-color: #e2ebdd; text-align: center;">
                            <tr>
                                <th>Product</th>
                                <th>Range</th>
                            </tr>
    ...
    ## Display "No Data Found" in table format
    echo '<div style="max-height: 800px; overflow-y: auto; border: 1px solid #ddd;">
