...
function get_create_post_list() {
    ...
    const sendData = {
        ...
        product_id: $("#product_id").val(), // Get the selected product id
    };
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            $("#create_post_list").html(xhr.responseText);
    ...
    xhr.open("POST", "templates/create_post/create_post_list.php", true);
    xhr.send(data);
}
...
function delete_data(create_post_id) {
    ...
    if (create_post_id > 0) {
        ...
        xhr.open('POST', 'templates/create_post/delete_data.php', true);
        xhr.send(data);
    } else {
