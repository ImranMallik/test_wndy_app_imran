...
//     xhr.open("POST", "templates/manage_demand_post/manage_post_list.php", true);
//     xhr.send(data);
// }
...
function populateEditModal(demandPostId, demandPostName, categoryId, brand, quantity) {
...
function submitEditForm() {
    ...
    .then(data => {
        if (data.success) {
            ...
            // alert("Demand post updated successfully!");
            location.reload(); 
        } else {
