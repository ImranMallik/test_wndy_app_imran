                ...
                <p><strong>Category:</strong> <?php echo htmlspecialchars($category_name); ?>
                    <?php if ($session_user_type == "Seller" && $product_status == "Active") { ?>
                        <a href="<?php echo "./seller-post-edit/" . $product_id; ?>">
                            <i class="bi bi-pencil-square edit-right" style="background-color: #c17f59 !important; padding: 4px 8px; border-radius: 3px; color:#fff !important; font-style: normal;">&nbsp;<span
                                    style="font-size:14px !important; font-weight: normal;">Edit</span></i>
                        </a>
                    <?php } ?>
                </p>
