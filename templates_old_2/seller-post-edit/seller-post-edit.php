  ...
  <main class="px-3 pb-4 mt-2">
    <form id="itemDetailsForm">
      <div class="mb-3">
        ...
        <input type="text" value="<?php echo htmlspecialchars($productData['product_name'] ?? ''); ?>" class="form-control" id="postName" placeholder="e.g: Waste">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" value="<?php echo htmlspecialchars($productData['description'] ?? ''); ?>" id="description" placeholder="e.g: description">
      </div>

      <div class="mb-3">
        <label for="brand" class="form-label">Brand</label>
        <input type="text" class="form-control" value="<?php echo htmlspecialchars($productData['brand'] ?? ''); ?>" id="brand" placeholder="e.g: WM">
      </div>

      <div class="mb-3">
        <label for="quantity" class="form-label">Quantity</label>
        <input type="text" class="form-control" value="<?php echo htmlspecialchars($productData['quantity'] ?? ''); ?>" id="quantity" placeholder="e.g: 1 Pcs, 2 k.g">
      </div>
      <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <div class="position-relative">
          <input type="text" class="form-control"
            value="<?php echo htmlspecialchars(number_format((float)$productData['sale_price'], 0, '', '')); ?>"
            id="price" placeholder="Eg - 2000">
        </div>
      </div>
