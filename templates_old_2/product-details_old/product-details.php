        ...
        <div class="container mt-4">
            ...
            <div class="mt-1">
                <p><strong>Category:</strong> <?php echo htmlspecialchars($category_name); ?>
                    <?php if ($session_user_type == "Seller" && $product_status == "Active") { ?>
                        <a href="<?php echo "./seller-post-edit/" . $product_id; ?>">
                            <i class="bi bi-pencil-square edit-right"></i>
                        </a>
                    <?php } ?>
                </p>

                <p><strong>Brand/Manufacture:</strong> <?php echo htmlspecialchars($brand); ?></p>
                <p><strong>Quantity:</strong>
                    <?php echo htmlspecialchars($quantity) . (!empty($quantity_unit) ? '(' . htmlspecialchars($quantity_unit) . ')' : ''); ?>
                </p>

                <p><strong>Description:</strong><?php echo nl2br(htmlspecialchars($description)); ?></p>
                <p><strong>Location:</strong> <?php echo htmlspecialchars("$city, $state, $pincode"); ?></p>
            </div>
            <!-- Buyer section start -->
            <?php
            ...
            ?>
                ...
                <?php if (!$product_view_data) { ?>
                    <button class="view-seller-btn mt-3 mb-5" onclick="checkCredits()">Use Credits to view Seller Info</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer text-center" style="justify-content: center;">
                                    ...
                                    <button type="button" onclick="userViewSellerDetails()" class="btn"
                                        style="padding: 6px 18px; border-radius: 6px; background-color: #b5753e; border-color: transparent;">Yes,
                                        Use Credits</button>
                                </div>
                            </div>
  ...
  color:#fff;">
                                    ...
                                    <?php } elseif ($negotiation_by == "Seller") { ?>
                                        <div class="buyer_confirm_box confirm-option-div animate__animated animate__backInUp">
                                            ...
                                            <button type="button" onclick="buyerNegotiate()" class="btn btn-warning">
                                                I want to Negotiate
                                            </button>
                                            <button type="button" onclick="buyerAcceptPrice()" class="btn btn-success">
                                                I accept
                                            </button>
                                        </div>
...
if (!empty($close_reason)) {
    ...
    echo '<span class="badges ' . $badgesClass . '">Closed By Seller</span>';
} else {
...
?>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                        <button type="button"
                                                            onclick="openRatingModal(<?php echo $rw['buyer_id']; ?>,<?php echo $rw['view_id']; ?>)"
                                                ...
                                                ?>
                                                    <div class="text-center">
                                                        ...
                                                        <button type="button" onclick="sellerAcceptPrice(<?php echo $rw['view_id']; ?>)" class="btn"
                                                            style="padding: 6px 50px; border-radius: 6px; background-color: #fff; color:#000; border-color: #000;">
                                                            Accept
                                                        </button>
                                                    </div>
                                                <?php
                        ...
                        <form class="product-form product-form-border hidedropdown">
                            ...
                            ?>
                                <div class="buyer_confirm_box confirm-option-div animate__animated animate__backInUp"
                                    ...
                                    <h2>Waiting for pickup</h2>
                                    <p style="font-weight: 600;">
                                        Pickup Datetime : <?php echo dateFormat($pickup_date); ?>,
                                        <?php echo timeFormat($rw['pickup_time']); ?>
                                    </p>
                                    <!-- <p style="font-weight: 600;">
