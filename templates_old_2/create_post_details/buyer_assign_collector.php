...
if ($login == "No") {
    ...
    if ($execute == 1) {
        mysqli_query($con, "update tbl_create_post_item_transactions set assigned_collecter='" . $collector_id . "' where buyer_id='" . $session_user_code . "' and product_id='" . $product_id . "' ");
        ...
        $noti_url = $baseUrl . "/create_product_details/" . $product_id;
