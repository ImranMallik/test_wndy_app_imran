		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<!--begin::Page Title-->
					<h5 class="text-dark font-weight-bold my-1 mr-5">Manage Product Sub-Category Details</h5>
					<!--end::Page Title-->
				</div>
				<!--end::Page Heading-->
			</div>
    ...
    <div class="modal-dialog entry_modal" role="document" style="width: 400px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title entry_modal_title" id="exampleModalLabel">Enter Product Sub-Category Details :</h5>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label">Sub-Category 
									...
									<!-- Info hover content -->
									<button type="button" class="info-label-btn btn btn-secondary" data-container="body" data-toggle="tooltip" data-placement="top" title="Product Sub-Category Name should be Unique">
										<i class="fas fa-info"></i>
									</button>
								</label>
								<input type="text" id="sub_category_name" class="form-control" placeholder="e.g: Waste" required maxlength="100">
								<label data-default-mssg="( This is unique field )" class="input_alert sub_category_name-inp-alert" ></label>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
