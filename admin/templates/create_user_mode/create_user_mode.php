		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<!--begin::Page Title-->
					<h5 class="text-dark font-weight-bold my-1 mr-5">Manage User Role Details</h5>
					<!--end::Page Title-->
				</div>
				<!--end::Page Heading-->
			</div>
...
<div class="modal fade" id="entryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog entry_modal" role="document" style="width: 450px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title entry_modal_title" id="exampleModalLabel">Enter User Role Details :</h5>
						...
						<div class="col-md-12">
							<div class="form-group">
								<label class="control-label">
                                    ...
                                    <!-- Info hover content -->
                                    <button type="button" class="info-label-btn btn btn-secondary" data-container="body" data-toggle="tooltip" data-placement="top" title="Duplicate Not Allowed. Define User Role Title e.g Admin, Super Admin, User">
                                        <i class="fas fa-info"></i>
                                    </button>
								</label>
								<input type="text" id="user_mode" class="form-control" placeholder="e.g Admin, Super Admin, User" required maxlength="50">
								<label data-default-mssg="" class="input_alert user_mode-inp-alert" ></label>
							</div>
						</div>
						<div class="col-md-12">
							<div class="form-group">
