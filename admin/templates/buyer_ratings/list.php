...
if ($view_permission == "Yes") {
	...
	$query = "SELECT 
        ...
        FROM tbl_ratings
		LEFT JOIN tbl_user_master AS buyer_details ON buyer_details.user_id = tbl_ratings.give_user_id
		LEFT JOIN tbl_user_master AS seller_details ON seller_details.user_id = tbl_ratings.to_user_id
		WHERE tbl_ratings.rating_from = 'Buyer' ";
