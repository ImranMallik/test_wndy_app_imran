		...
		<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
			...
			<div class="d-flex align-items-center flex-wrap mr-1">
				...
				<div class="d-flex align-items-baseline flex-wrap mr-5">
					<!--begin::Page Title-->
					<h5 class="text-dark font-weight-bold my-1 mr-5">Manage Sub Menu Details</h5>
					<!--end::Page Title-->
				</div>
				<!--end::Page Heading-->
			</div>
    ...
    <div class="modal-dialog entry_modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title entry_modal_title" id="exampleModalLabel">Enter Sub Menu Details :</h5>
            ...
            <div class="modal-body entry_modal_body">
				<div class="input_part">
					<input type="hidden" id="sub_menu_code" value="" />
					
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label class="control-label">Sub Menu Name </label>
								<input type="text" id="sub_menu_name" class="form-control" placeholder="Enter Sub Menu Name" required maxlength="150">
								<label data-default-mssg="( This is unique field )" class="input_alert sub_menu_name-inp-alert" ></label>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label class="control-label">Menu Icon </label>
								<input type="text" value="fa fa-circle-notch" id="menu_icon" class="form-control" placeholder="Enter Menu Icon" required maxlength="150">
								<label data-default-mssg="" class="input_alert menu_icon-inp-alert" ></label>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label class="control-label">Master Menu</label>
								<select id="menu_code" class="form-control select2" data-placeholder="Choose Master Menu" required>
									<option value=""></option>
									<?php
									$menu_master_dataget = mysqli_query($con,"select menu_code,menu_name from menu_master where active='Yes' and sub_menu_status='Yes' ");
									while($rw = mysqli_fetch_assoc($menu_master_dataget)){
									?>
									<option value="<?php echo $rw['menu_code'] ?>"><?php echo $rw['menu_name'] ?></option>
									<?php
									}
									?>
								</select>
								<label data-default-mssg="" class="input_alert menu_code-inp-alert" ></label>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label class="control-label">File Name </label>
								<input type="text" id="file_name" class="form-control" placeholder="Enter File Name" required maxlength="150">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" id="folder_name" class="form-control" placeholder="Enter Folder Name" required maxlength="150">
