        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Manage Buyers Addresses Details</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group">
                <label class="control-label"><b>Select Buyer</b></label>
                <select id="user_id_search" class="select2 form-control" data-placeholder="Choose Buyer" onchange="reload_table()">
    ...
    <div class="modal-dialog entry_modal" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title entry_modal_title" id="exampleModalLabel">Enter Buyer Address Details :</h5>
                        ...
                        <div class="col-md-3">
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <!-- Info hover content -->
                                <button type="button" class="info-label-btn btn btn-secondary" data-container="body" data-toggle="tooltip" data-placement="top" title="Buyer Type">
                                    <i class="fas fa-info"></i>
                                </button>
                                <select id="buyer_type" class="select2 form-control"  data-placeholder="Scrap Dealer" required></select>
                                <label data-default-mssg="" class="input_alert user_id-inp-alert"></label>
                            </div>
                        </div>
                        <div class="col-md-3">
