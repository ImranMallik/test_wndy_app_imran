        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-1 mr-5">Manage Buyers Wishlists Details</h5>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
...
<div class="modal fade" id="entryModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog entry_modal" role="document">
        <div class="modal-content" style="max-width: 460px; margin: auto;">
            <div class="modal-header">
                <h5 class="modal-title entry_modal_title" id="exampleModalLabel">Enter Wishlist Details :</h5>
            ...
            <div class="modal-body entry_modal_body">
                <div class="input_part">
                    <input type="hidden" id="wishlist_id" value="" />
                    <div class="row" style="flex-direction: column; align-items: center;">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <!-- Info hover content -->
                                <button type="button" class="info-label-btn btn btn-secondary" data-container="body" data-toggle="tooltip" data-placement="top" title="Buyer Name Dropdown">
                                    <i class="fas fa-info"></i>
                                </button>
                                <select id="buyer_id" class="select2 form-control" data-placeholder="e.g: John Doe [7895412345]" required></select>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <!-- Info hover content -->
                                <button type="button" class="info-label-btn btn btn-secondary" data-container="body" data-toggle="tooltip" data-placement="top" title="Product Name Dropdown">
                                    <i class="fas fa-info"></i>
                                </button>
            ...
            <div class="modal-footer entry_modal_footer justify-content-center">
