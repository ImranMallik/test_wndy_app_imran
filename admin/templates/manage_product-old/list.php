...
if ($view_permission == "Yes") {
	...
	while ($row = mysqli_fetch_assoc($empRecords)) {
		...
		} elseif ($row['product_status'] == "Post Viewed") {
		...
		} elseif ($row['product_status'] == "Under Negotiation") {
		...
		} elseif ($row['product_status'] == "Offer Accepted") {
		...
		} elseif ($row['product_status'] == "Pickup Scheduled") {
		...
		} elseif ($row['product_status'] == "Completed") {
		...
		} else if ($row['product_status'] == "Third-Party Transaction") {
