...
if ($address_count > 0) {
  ...
  echo $addresses;
  if ($address_count >= 1) {
    echo '<a href=' . $baseUrl . '/manage_sellers_addresses/MC_65b217b18afaa1706170289/' . $user_id . ' target="_blank;"><button type="button" class="btn btn-light-primary font-weight-bold desktop_view" style="margin-top: 20px; color: primary;" id="manageAddressButton">Manage Address</button></a>';
  }
} else {
