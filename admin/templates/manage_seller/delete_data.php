...
mysqli_query($con, "DELETE FROM tbl_address_master WHERE tbl_address_master.user_id='" . $user_id . "' ");

$activity_details = "You Delete A Record From Manage Sellers Details";
