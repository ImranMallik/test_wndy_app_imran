...
function userViewSellerDetails(event, product_id) {
            ...
            if (viewXhr.status === 200) {
                try {
                    ...
                    if (status === "SessionDestroy") {
                        ...
                        setTimeout(() => window.location.href = baseUrl + "/wallet", 2000);
                    } else if (status === "error") {
                        // toastr["error"](status_text, "ERROR!!");
                    } else {
                        // toastr["success"](status_text, "SUCCESS!!");
                        setTimeout(() => {
                            window.location.href = baseUrl + "/product-details/" + product_id;
                        }, 1000);
                    }
                } catch (e) {
    ...
    viewXhr.open("POST", "templates/product_list/buyer_view_product.php", true);
    viewXhr.send(data);
}
