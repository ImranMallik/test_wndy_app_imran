...
echo '<div class="container cont" style="background-color: #ffeedf; border-radius:0px 0px 8px 8px; padding-bottom:10px;">
    ...
    echo '<p class="rate-list-description">Scrap is valued by weight. Final rates depend on the weight of collected products</p> 
            <div class="custom-scrollbar-container">
                <table class="table table-bordered table-hover" style="margin: 0;">
                    <thead style="color:#fff;position: sticky; top: 0; z-index: 9999; background-color: #b5753e; text-align: center">
                        <tr>
                            <th>Product</th>
                            <th>Range</th>
                        </tr>
