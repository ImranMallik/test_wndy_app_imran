                ...
                <div>
                    ...
                    <div class="address-text">
                        ...
                        <b>Address Line:</b> <?php echo htmlspecialchars($rw['address_line_1']); ?>
                                                                    ...
                                                                    <button type="button" class="bottom-btn btn-sm pb-2 edit-address-btn" style="background-color:#c17f59 !important; border:none;" data-bs-toggle="modal"  data-bs-target="#addNewModal" data-address-id="<?php echo $rw['address_id']; ?>">
