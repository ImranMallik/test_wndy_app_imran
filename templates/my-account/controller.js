...
function updateProfileDetails() {
  ...
  if (!_("#email_id").value.includes("@") && _("#email_id").value != "") {
    // Check if the email does not contain '@'
    toastr['warning']("Email: Invalid Email Format - '@' is missing", "WARNING");
    showInputAlert('email_id', 'warning', "Invalid Email Format - '@' is missing");
    _("#email_id").focus();
    execute = 0;
    return false;
}
