...
if ($login == "No") {
    ...
    if ($execute == 1) {
        ...
        $product_dataget = mysqli_query($con, "select demand_post_by_id from tbl_demand_post where product_id='" . $product_id . "' ");
        $product_data = mysqli_fetch_assoc($product_dataget);
        $seller_id = $product_data['demand_post_by_id'];
        ...
        mysqli_query($con, "INSERT INTO tbl_demand_post_item_transactions(
            trans_id,
            buyer_id,
            product_id,
            view_date, 
