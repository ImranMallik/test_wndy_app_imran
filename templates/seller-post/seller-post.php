...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="quantityKg" placeholder="e.g: 0.5, 1, 1.5">
            ...
            <div class="mb-3">
                <label for="price" class="form-label">Expected Total Value<span class="text-danger">*</span></label>
...
<div id="step3" class="container d-none">
    <div class="address-container" style="background-color: transparent !important; padding:0px !important;" >
        <div class="mb-4">
            <div class="d-flex align-items-center">
