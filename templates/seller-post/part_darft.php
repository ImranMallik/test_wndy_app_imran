...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (mysqli_num_rows($checkPost) > 0) {
        ...
        if (isset($_POST['quantityPcs'])) {
    $quantityPcs = mysqli_real_escape_string($con, $_POST['quantityPcs']);
    $updateFields[] = "quantity_pcs = '$quantityPcs'";
}

if (isset($_POST['quantityKg'])) {
    $quantityKg = mysqli_real_escape_string($con, $_POST['quantityKg']);
    $updateFields[] = "quantity_kg = '$quantityKg'";
}
        ...
        // Retrieve product_id after update
