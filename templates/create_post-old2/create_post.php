        ...
        <div class="col-md-5">
            <div class="form-group">
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <!-- <h2 style="margin: 0;">
                        <strong>Filter Post Category</strong>
                    </h2> -->
                    <button style="background-color: #4eaf52; padding: 4px 7px; align-items:center;" class="btn">
                        <a href="<?php echo $baseUrl ?>/manage_post" style="color: #FFF; text-decoration: none;font-size:10px">
                            Manage Your Post
                        </a>
                    </button>
                </div>
                ...
                <select class="form-control" id="category_id" onchange="get_create_post_list()" required>
                    ...
                    //                     $fetchData = mysqli_query($con, "SELECT DISTINCT c.category_id, c.category_name 
                    // FROM tbl_category_master c 
                    // INNER JOIN tbl_create_post p 
                    //     ON c.category_id = p.category_id 
                    // WHERE p.create_post_status = 'active' 
                    //     AND p.create_post_by_id != '$session_user_code'");
