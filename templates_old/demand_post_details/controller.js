...
function userViewSellerDetails(params) {
  ...
  if (execute == 1) {
    ...
    viewXhr.open("POST", "templates/demand_post_details/buyer_view_product.php", true);
    viewXhr.send(data);
  }
}
...
function assignCollector(params) {
  ...
  if (execute == 1) {
    ...
    assignXhr.open("POST", "templates/demand_post_details/buyer_assign_collector.php", true);
    assignXhr.send(data);
  }
}
...
function buyerSendRequest() {
  ...
  if (execute == 1) {
    ...
    xhr.open("POST", "templates/demand_post_details/buyer_send_request.php", true);
    xhr.send(data);
  }
}
...
function buyerAcceptPrice() {
  ...
  if (execute == 1) {
    ...
    xhr.open("POST", "templates/demand_post_details/buyer_accept_price.php", true);
    xhr.send(data);
  }
}
...
function buyerPickupComplete(view_id) {
  ...
  if (execute == 1) {
    ...
    xhr.open("POST", "templates/demand_post_details/buyer_pickup_complete.php", true);
    xhr.send(data);
  }
}
...
function buyerSaveRatings() {
  ...
  if (execute == 1) {
    ...
    xhr.open("POST", "templates/demand_post_details/buyer_save_ratings.php", true);
    xhr.send(data);
  }
}
...
function sellerSendRequest() {
  ...
  if (execute == 1) {
    ...
    xhr.open("POST", "templates/demand_post_details/seller_send_request.php", true);
    xhr.send(data);
  }
}
...
function updatePickupDate() {
  ...
  if (execute == 1) {
    ...
    xhr.open("POST", "templates/demand_post_details/seller_update_pickup_date.php", true);
    xhr.send(data);
  }
}
...
function sellerCloseProduct(view_id) {
  ...
  if (execute == 1) {
    ...
    xhr.open("POST", "templates/demand_post_details/seller_close_product.php", true);
    xhr.send(data);
  }
}
...
function sellerSaveRatings() {
  ...
  if (execute == 1) {
    ...
    xhr.open("POST", "templates/demand_post_details/seller_save_ratings.php", true);
    xhr.send(data);
  }
}
