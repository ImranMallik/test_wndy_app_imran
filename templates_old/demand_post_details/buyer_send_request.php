...
if ($login == "No") {
    ...
    if ($execute == 1) {
        ...
        if ($sellerPhnNum) {
            ...
            $sendTextMessage = "Dear '" . $sellerName . "', There is a buyer who has offered INR '" . $negotiation_amount . "' on your post. Kindly check and let your scrap sold and get prices";
            sendWhatsappMessage();
        }
