...
<?php
// Fetch product counts only for specific statuses
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="main-sellerItemListingChart">
                        ...
                        $dataget = mysqli_query($con, "select count(*) from tbl_product_master where user_id='" . $session_user_code . "' and product_status IN ('Active','Post Viewed') ");
...
// Using alias for count and optional security best practices
     $open_product = mysqli_query($con, "SELECT COUNT(*) AS total_open_product FROM tbl_product_master WHERE active = 'Yes' AND product_status IN ('Active', 'Post Viewed')
");
     $open_product_rw = mysqli_fetch_assoc($open_product);
      ?>
...
onclick="setFilterUnderNegotiation(event, 'Active')">
    ...
    FROM tbl_product_master 
    WHERE active = 'Yes' AND product_status IN ('Active', 'Post Viewed')
");
$data = mysqli_fetch_row($dataget);
