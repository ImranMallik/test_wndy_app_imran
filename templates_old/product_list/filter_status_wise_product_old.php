...
if ($session_user_type == "Seller") {
 ...
 if ($product_status == "in-process") {
    ...
    $where .= " AND p.active = 'Yes' AND p.product_status IN ('Active','Post Viewed','Under Negotiation')";
...
elseif ($product_status == "Pickup Scheduled") {
    ...
    $where .= " AND p.product_status NOT IN ('Completed', 'Third-Party Transaction','Pickup Scheduled')";
} else {
    $where .= " AND p.product_status != 'Completed'";
}
...
if ($session_user_type === "Buyer") {
 ...
 elseif ($session_user_type === "Seller") {
    if ($rw['product_status'] === "Active" || $rw['product_status'] === "Post Viewed") {
        $statusLabel = "Open";
    } elseif ($rw['product_status'] === "Completed") {
        $statusLabel = "Closed";
