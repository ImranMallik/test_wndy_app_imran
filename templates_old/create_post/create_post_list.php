        ...
        ");
            ...
            ?>
                <div class="col-4 col-sm-4 col-md-3 col-lg-3 mb-4">
                    <a href="<?php echo "./create_post_details/" . $row['create_post_id']; ?>" class="card" style="border: none; border-radius: 15px; overflow: hidden; position: relative; max-width: 100%;">
