...
WHERE cp.create_post_id = '$create_post_id'";
                        ...
                        <div class="product-details-img product-horizontal-style">
                            ...
                            <div class="zoompro-wrap">
                                <div class="zoompro-span">
                                    <img id="zoompro" class="zoompro" src="upload_content/upload_img/product_img/<?php echo $file_name; ?>" style="object-fit: cover; height: 300px; width: 100%;" data-zoom-image="upload_content/upload_img/product_img/<?php echo $file_name; ?>" alt="product" />
                                </div>
                            </div>
