        ...
        <div class="container mt-4">
            ...
            <div class="mt-1">
                <p><strong>Category:</strong> <?php echo htmlspecialchars($category_name); ?>
                    <?php if ($session_user_type == "Seller" && $product_status == "Active") { ?>
                        <a href="<?php echo "./seller-post-edit/" . $product_id; ?>">
                            <i class="bi bi-pencil-square edit-right">&nbsp;<span
                                    style="font-size:14px !important; font-family: Poppins, sans-serif !important;">Edit</span></i>
                        </a>
                    <?php } ?>
                </p>
                ...
                <p><strong>Location:</strong>
                    <?php echo htmlspecialchars("$landmark,$address_line_1,$city, $state, $pincode,$country"); ?></p>
            </div>
